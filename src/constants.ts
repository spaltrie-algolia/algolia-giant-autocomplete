...
export const ALGOLIA_PRODUCTS_INDEX_NAME = "giant_bikes_curated"; //"giant_bikes_simon_edit";
export const ALGOLIA_PRODUCTS_QUERY_SUGGESTIONS_INDEX_NAME =
  "giant_bikes_curated_query_suggestions";
export const ALGOLIA_ARTICLES_INDEX_NAME = "giant_blog";
